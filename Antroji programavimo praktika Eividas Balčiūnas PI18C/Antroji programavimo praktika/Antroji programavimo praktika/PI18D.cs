...
{
    public partial class PI18D : Form
    {
        public PI18D()
        {
            InitializeComponent();
        ...
        private void PridetiStudenta_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (StreamWriter writer = new StreamWriter("c:\\users\\x\\desktop\\antroji programavimo praktika eividas balčiūnas pi18c\\antroji programavimo praktika\\vartotojai\\PI18D.txt", true))
                {
        ...
        private void Atnaujinti_Click(object sender, EventArgs e)
        {
            ...
            string[] lines = File.ReadAllLines("c:\\users\\x\\desktop\\antroji programavimo praktika eividas balčiūnas pi18c\\antroji programavimo praktika\\vartotojai\\PI18D.txt");
        ...
        private void IstrintiStudenta_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (StreamReader reader = new StreamReader("C:\\Users\\x\\Desktop\\Antroji programavimo praktika Eividas Balčiūnas PI18C\\Antroji programavimo praktika\\Vartotojai\\PI18D.txt"))
                {
                    string line;
                ...
                using (StreamWriter writer = new StreamWriter("c:\\users\\x\\desktop\\antroji programavimo praktika eividas balčiūnas pi18c\\antroji programavimo praktika\\vartotojai\\PI18D.txt"))
                {
